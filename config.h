...
static const char *fonts[]          = { "abel:size=10" };
...
static const Rule rules[] = {
	...
	{ "Color-picker",	NULL,        NULL,  		0,         	   	0,      	   1,           -1 },
...
/* commands */
static const char  *scriptcmd[]  = { "sclauncher", NULL };
static const char  *clipb[]      = { "clipboard", NULL };
static const char  *termcmd[]    = { "tabbed", "-c", "-n", "tabbed_st", "-t", "#ff8787", "-u", "#8a6d70", "st", "-w", NULL };
static const char  *term2cmd[]   = { "tabbed", "-c", "-n", "tabbed_stdark","-t", "#ff8787", "-u", "#8a6d70", "st_dark", "-w", NULL };
static const char  scratchname[] = "scratchpad";
static const char  *scratchcmd[] = { "st_dark", "-t", scratchname, "-g", "80x40+315+30", NULL }; // kinda buggy try not to use it on a floating layout
static const char  *brightplus[] = { "brightnessctl", "s", "+10", NULL };
static const char  *brightmin[]  = { "brightnessctl", "s", "10-", NULL };
static const char  *scrotcmd[]   = { "scrot", "%b%d-scr%H%M%S_%s_$wx$h.png", "-e", "mv $f ~/Pictures/scr/", NULL };
